...
filename="main_logit_2way" # nam prefix
model = LogisticRegression(C=0.7, penalty="l2")  # the classifier we'll use

# === load data in memory === #
print ("loading data")
y, X = load_data('/Users/ck/Desktop/all_code/input/train.csv')
y_test, X_test = load_data('/Users/ck/Desktop/all_code/input/test.csv', use_labels=False)
...
# save_results(preds, filename+"_submission_"  + ".csv")
