...
model=xg.XGBoostClassifier(num_round=500 ,nthread=25,  eta=0.02, gamma=1,max_depth=20, min_child_weight=0.1, subsample=0.9, 
                                   colsample_bytree=0.5,objective='binary:logistic',seed=1) 

# === load data in memory === #
print ("loading data")
y, X,X_test = load_datacount2D('/Users/ck/Desktop/all_code/input/train.csv','/Users/ck/Desktop/all_code/input/test.csv')
